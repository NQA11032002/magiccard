<input type="checkbox" hidden name="" id="cbInventory1">
<label for="cbInventory1" class="label_Inventory"></label>
             ...
             <li class="drop-account">
                <div class="header--account">
                    ...
                    <div class="header--name">
                        <h2><?php echo $_SESSION["logined"][0]->name ?><img src="https://i.imgur.com/NgPdSKZ.png"></h2>
    ...
    <p class="header-power">Bang Hội:
            ...
            <div class="equipment_left">
                <div class="wear_equipment">
                    <img class="wear_weapon"
                        src="https://i.imgur.com/hyzJCyr.png"
                        alt="">

                    <button class="remove__equipment remove_weapon">Tháo ra</button>

                    <div class="details__weared">
                        <img class="details__weared--img details__weared--weapon__img"
                            src="" alt="">
                        <h2 class="details__weared--name details__weared--weapon__name">
                        </h2>
                        <p
                            class="details__weared--attack details__weared--weapon__attack">
                        </p>
                        <p
                            class="details__weared--defens details__weared--weapon__defense">
                        </p>
                ...
                <div class="wear_equipment">
                    ...
                    <div class="details__weared">
                        <img class="details__weared--img details__weared--phi_phong__img"
                            src="" alt="">
                        <h2
                            class="details__weared--name details__weared--phi_phong__name">
                        </h2>
                        <p
                            class="details__weared--attack details__weared--phi_phong__attack">
                        </p>
                        <p
                            class="details__weared--defens details__weared--phi_phong__defense">
                        </p>
                        <p
                            class="details__weared--blood details__weared--phi_phong__blood">
                        </p>
                    </div>
                </div>
                ...
                <div class="wear_equipment">
                    ...
                    <div class="details__weared">
                        <img class="details__weared--img details__weared--belt__img"
                            src="" alt="">
                ...
                <div class="wear_equipment">
                    <img class="wear_jewel_1"
                        src="https://i.imgur.com/hyzJCyr.png"
                        alt="">
                    <button class="remove__equipment remove_jewel_1">Tháo ra</button>

                    <div class="details__weared">
                        <img class="details__weared--img details__weared--jewel_1__img"
                            src="" alt="">
                        <h2 class="details__weared--name details__weared--jewel_1__name">
                        </h2>
                        <p
                            class="details__weared--attack details__weared--jewel_1__attack">
                        </p>
                        <p
                            class="details__weared--defens details__weared--jewel_1__defense">
                        </p>
                ...
                <div class="wear_equipment">
                    ...
                    <div class="details__weared">
                        <img class="details__weared--img details__weared--jewel_2__img"
                            src="" alt="">
                        <h2 class="details__weared--name details__weared--jewel_2__name">
                        </h2>
                        <p
                            class="details__weared--attack details__weared--jewel_2__attack">
                        </p>
                        <p
                            class="details__weared--defens details__weared--jewel_2__defense">
                        </p>
            ...
            <div class="equipment_bottom">
                <div class="wear_equipment">
                    <img class="wear_skill"
                        src="https://i.imgur.com/QhblmnB.png"
                        alt="">

                    <button
                        class="remove__equipment remove__equipment--bottom remove_skill">Tháo
                        ra</button>

                    <div class="details__weared">
                        <img class="details__weared--img details__weared--skill__img"
                            src="" alt="">
                        ...
                        <p
                            class="details__weared--defens details__weared--skill__defense">
                        </p>
                ...
                <div class="wear_equipment">
                    <img class="wear_phap_bao"
                        src="https://i.imgur.com/QhblmnB.png"
                        alt="">

                    <button
                        class="remove__equipment remove__equipment--bottom remove_phap_bao">Tháo
                        ra</button>

                    <div class="details__weared">
                        <img class="details__weared--img details__weared--phap_bao__img"
                            src="" alt="">
                        <h2 class="details__weared--name details__weared--phap_bao__name">
                        </h2>
                        <p
                            class="details__weared--attack details__weared--phap_bao__attack">
                        </p>
                        <p
                            class="details__weared--defens details__weared--phap_bao__defense">
                        </p>
                        <p
                            class="details__weared--blood details__weared--phap_bao__blood">
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="equipment_right">
                <div class="wear_equipment">
                    <img class="wear_hat"
                        src="https://i.imgur.com/6GIkC60.png"
                        alt="">

                    <button class="remove__equipment remove_hat">Tháo ra</button>

                    <div class="details__weared">
                        <img class="details__weared--img details__weared--hat__img" src=""
                            alt="">
                ...
                <div class="wear_equipment">
                    ...
                    <div class="details__weared">
                        <img class="details__weared--img details__weared--coat__img"
                            src="" alt="">
                ...
                <div class="wear_equipment">
                    ...
                    <div class="details__weared">
                        <img class="details__weared--img details__weared--glove__img"
                            src="" alt="">
                        ...
                        <p
                            class="details__weared--defens details__weared--glove__defense">
                        </p>
                ...
                <div class="wear_equipment">
                    ...
                    <div class="details__weared">
                        <img class="details__weared--img details__weared--shoese__img"
                            src="" alt="">
                        <h2 class="details__weared--name details__weared--shoese__name">
                        </h2>
                        <p
                            class="details__weared--attack details__weared--shoese__attack">
                        </p>
                        <p
                            class="details__weared--defens details__weared--shoese__defense">
                        </p>
                ...
                <div class="wear_equipment">
                    ...
                    <div class="details__weared">
                        <img class="details__weared--img details__weared--jewel_3__img"
                            src="" alt="">
                        <h2 class="details__weared--name details__weared--weapon__name">
                        </h2>
                        <p
