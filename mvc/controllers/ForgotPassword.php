    ...
    class ForgotPassword extends Controller
    {
        ...
        function recovery()
        {
            ...
            require './Public/package/PHPMailer-master/src/Exception.php'; 
                ...
                $mode = $this->model("forgotpasswordModel");
                    ...
                    $mail = new PHPMailer\PHPMailer\PHPMailer(true);//true:xử lý lỗi nếu có
                        ...
                        if($mode->checkEmail($email) === true)
                        {
                            try {
                                ...
                                $mail->Username = 'volamthienha.hotro@gmail.com'; //TK email gửi
                                $mail->Password = '';   // pass email gửi
                                $mail->SMTPSecure = 'ssl';  // encryption SSL/Port = 465  TSL/Port = 587
                                $mail->Port = 465;  // port to connect to                
                                $mail->setFrom('volamthienha.hotro@gmail.com', 'Hỗ trợ khôi phục mật khẩu.' ); //địa chỉ email người gửi
                                $mail->addAddress($email, $email); //mail và tên người nhận  
                                $mail->isHTML(true);  // Set email format to HTML
                                $mail->Subject = 'Khôi phục mật khẩu'; //tiêu đề thư
