	...
	let guilds = [
		{
			...
			name: "Tàn Sát",
			master: "正恒pop",
			power: 587651 + Math.floor(Math.random() * 1000) + 1,
			sever: "S3-Việt Nam",
			page: 0
		},
		{
			...
			name: "Ăn Chơi",
			master: "Dân Thường",
			power: 616000 + Math.floor(Math.random() * 1000) + 1,
			sever: "S1-Việt Nam",
			page: 0
		},
		{
			...
			power: 510000 + Math.floor(Math.random() * 1000) + 1,
			sever: "S2-Việt Nam",
			page: 0
		},
		{
			...
			name: "Đại Anh Hùng",
			master: "Miss Neko",
			power: 420600 + Math.floor(Math.random() * 1000) + 1,
			sever: "S1-Việt Nam",
			page: 0
		},
		{
			...
			power: 460600 + Math.floor(Math.random() * 1000) + 1,
			sever: "S3-Việt Nam",
			page: 0
		},
		{
			...
			name: "Tam Giới",
			master: "Hoàng Đại Đế",
			power: 450500 + Math.floor(Math.random() * 1000) + 1,
			sever: "S2-Việt Nam",
			page: 0
		},
		{
			...
			name: "Push",
			master: "Tài Phệt",
			power: 400600 + Math.floor(Math.random() * 1000) + 1,
			sever: "S1-Việt Nam",
			page: 0
		},
		{
			...
			name: "Ma Giáo",
			master: "Tiêu Yun",
			power: 390600 + Math.floor(Math.random() * 1000) + 1,
			sever: "S1-Việt Nam",
			page: 0
		},
		{
			...
			name: "Đoạt Mệnh",
			master: "Mad",
			power: 420900 + Math.floor(Math.random() * 1000) + 1,
			sever: "S2-Việt Nam",
			page: 0
		},
		{
			...
			name: "Ngạo Thiên",
			master: "Hades",
			power: 340200 + Math.floor(Math.random() * 1000) + 1,
			sever: "S1-Việt Nam",
			page: 0
		},
	];
